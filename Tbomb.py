...
# Author: h.r.aziz
# GitHub: https://github.com/azizulislam3
# Version: 4.1.0
#########################################
...
def logo():
    ...
    print("\033[94m│     \033[92m | .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. || .--------------. |\033[94m   │".center(columns+15))
    print("\033[94m│     \033[92m | |  ____  ____  | || |              | || |  _______     | || |              | || |   ______     | || |     ____     | || | ____    ____ | || |   ______     | || |  _________   | || |  _______     | |\033[94m   │".center(columns+15))
    print("\033[94m│     \033[92m | | |_   ||   _| | || |              | || | |_   __ \    | || |              | || |  |_   _ \    | || |   .'    `.   | || ||_   \  /   _|| || |  |_   _ \    | || | |_   ___  |  | || | |_   __ \    | | \033[94m   │".center(columns+15))
    print("\033[94m |      \033[92m | |   | |__| |   | || |              | || |   | |__) |   | || |              | || |    | |_) |   | || |  /  .--.  \  | || |  |   \/   |  | || |    | |_) |   | || |   | |_  \_|  | || |   | |__) |   | |
    print("\033[94m│     \033[92m | |   |  __  |   | || |              | || |   |  __ /    | || |              | || |    |  __'.   | || |  | |    | |  | || |  | |\  /| |  | || |    |  __'.   | || |   |  _|  _   | || |   |  __ /    | |
    print("\033[94m│     \033[92m | |  _| |  | |_  | || |      _       | || |  _| |  \ \_  | || |      _       | || |   _| |__) |  | || |  \  `--'  /  | || | _| |_\/_| |_ | || |   _| |__) |  | || |  _| |___/ |  | || |  _| |  \ \_  | |
    print("\033[94m│     \033[92m | | |____||____| | || |     (_)      | || | |____| |___| | || |     (_)      | || |  |_______/   | || |   `.____.'   | || ||_____||_____|| || |  |_______/   | || | |_________|  | || | |____| |___| | |
    print("\033[94m│     \033[92m | |              | || |              | || |              | || |              | || |              | || |              | || |              | || |              | || |              | || |              | |
    print("\033[94m│     \033[92m | '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' || '--------------' |
    print("\033[94m│     \033[92m  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------'  '----------------' 
    print("\033[94m│                              \033[94m          │".center(columns+9))
    print("\033[94m│ \033[95mAuthor : H.R.aziz             \033[94m│".center(columns+15))
    print("│ \033[95mTool   : Unlimited SMS Bomber          \033[94m│".center(columns+9))
    print("│ \033[95mGitHub : https://github.com/azizulislam3 \033[94m│".center(columns+9))
    print("│ \033[95mCoder  :  h.r.aziz        \033[37mV4.1 \033[94m│".center(columns+15))
    print("\033[94m└────────────────────────────────────────┘".center(columns+5))
